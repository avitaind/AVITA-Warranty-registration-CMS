                                            ...
                                            <div class=" container">
                                                <div class="col-12 col-md-12 col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-md-6">
                                                            <div class="mb-3">
                                                                <label for="ticketOld" class="form-label">Previous Complaint ID <span class="required">(Optional)</span></label>
                                                                <input type="text"
                                                        ...
                                                        <div class="col-md-4 col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <select
                                                                    ...
                                                                    id="warrantyCheck"
                                                                    aria-describedby="warrantyCheckHelp"
                                                                    name="warrantyCheck">
                                                                    <option value="">------</option>
                                                        ...
                                                        <div class="col-md- col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <select
                                                                    ...
                                                                    id="chanalPurchase"
                                                                    aria-describedby="chanalPurchaseHelp"
                                                                    name="chanalPurchase">
                                                                    <option value="">------</option>
